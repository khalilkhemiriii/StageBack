...
class CategoryResourceIT {
    ...
    private static final Integer DEFAULT_ID_CAT = 1;
    private static final Integer UPDATED_ID_CAT = 2;
    ...
    public static Category createEntity() {
        Category category = new Category().id_cat(DEFAULT_ID_CAT).categoryName(DEFAULT_CATEGORY_NAME);
        return category;
    }
    ...
    public static Category createUpdatedEntity() {
        Category category = new Category().id_cat(UPDATED_ID_CAT).categoryName(UPDATED_CATEGORY_NAME);
        return category;
    }
    ...
    void createCategory() throws Exception {
        ...
        assertThat(testCategory.getId_cat()).isEqualTo(DEFAULT_ID_CAT);
    ...
    void getAllCategories() throws Exception {
        ...
        restCategoryMockMvc
            ...
            .andExpect(jsonPath("$.[*].id_cat").value(hasItem(DEFAULT_ID_CAT)))
    ...
    void getCategory() throws Exception {
        ...
        restCategoryMockMvc
            ...
            .andExpect(jsonPath("$.id_cat").value(DEFAULT_ID_CAT))
    ...
    void putNewCategory() throws Exception {
        ...
        updatedCategory.id_cat(UPDATED_ID_CAT).categoryName(UPDATED_CATEGORY_NAME);
        ...
        Category testCategory = categoryList.get(categoryList.size() - 1);
        assertThat(testCategory.getId_cat()).isEqualTo(UPDATED_ID_CAT);
    ...
    void partialUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.id_cat(UPDATED_ID_CAT);
    ...
    void fullUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.id_cat(UPDATED_ID_CAT).categoryName(UPDATED_CATEGORY_NAME);
