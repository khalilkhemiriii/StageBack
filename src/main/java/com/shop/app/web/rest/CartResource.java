...
/**
 * REST controller for managing {@link com.shop.app.domain.Cart}.
 */
@RestController
@RequestMapping("/api")
public class CartResource {
     ...
     */
    @PutMapping("/carts/{id}")
    public ResponseEntity<CartDTO> updateCart(@PathVariable(value = "id", required = false) final String id, @RequestBody CartDTO cartDTO)
    ...
    public ResponseEntity<CartDTO> partialUpdateCart(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, cartDTO.getId())
        );
    }
