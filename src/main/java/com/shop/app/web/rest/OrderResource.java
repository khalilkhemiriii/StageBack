...
/**
 * REST controller for managing {@link com.shop.app.domain.Order}.
 */
@RestController
@RequestMapping("/api")
public class OrderResource {
    ...
    public ResponseEntity<OrderDTO> updateOrder(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, orderDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<OrderDTO> partialUpdateOrder(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, orderDTO.getId())
        );
    }
